...
export const authCopy = {
  zh: {
    ...
    verifyEmailSubject: "验证你的 tonylaw.cc 账号",
    verifyEmailText: "请点击下面的链接验证邮箱：{url}",
    verifyEmailHtmlIntro: "请点击下面的链接验证邮箱。",
    verifyEmailAction: "验证邮箱",
    invalidToken: "链接无效或已过期，请重新申请。",
    resetPasswordSubject: "重置你的 tonylaw.cc 密码",
    resetPasswordText: "请点击下面的链接重置密码：{url}",
    resetPasswordHtmlIntro: "请点击下面的链接重置密码。",
  ...
  en: {
    ...
    verifyEmailSubject: "Verify your tonylaw.cc account",
    verifyEmailText: "Please verify your account by opening: {url}",
    verifyEmailHtmlIntro: "Please verify your account by opening the link below.",
    verifyEmailAction: "Verify email",
    invalidToken: "This link is invalid or expired. Please request a new one.",
    resetPasswordSubject: "Reset your tonylaw.cc password",
    resetPasswordText: "Reset your password by opening: {url}",
    resetPasswordHtmlIntro: "Reset your password by opening the link below.",
