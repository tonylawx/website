      ...
      <section className="theme-shell max-w-[460px]">
        <div className="theme-paper overflow-hidden">
          <div className="theme-header-panel">
            ...
            <h1 className="mt-3 text-[34px] leading-[1.05] font-semibold">{text.verifyTitle}</h1>
            <p className="mt-3 text-sm text-white/80">{text.verifyDescription}</p>
          </div>
          <section className="p-4 md:p-5">
            <div className="theme-card p-5 md:p-6">
              <form onSubmit={handleSubmit} className="grid gap-4">
                ...
                <button type="submit" className="theme-button-primary">{text.verifySubmit}</button>
              </form>
