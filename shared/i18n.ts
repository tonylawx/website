...
export const uiCopy = {
  zh: {
    ...
    opportunitiesViewReport: "看报告",
    opportunitiesCopyContract: "复制合约",
  ...
  en: {
    ...
    opportunitiesViewReport: "View Report",
    opportunitiesCopyContract: "Copy Contract",
